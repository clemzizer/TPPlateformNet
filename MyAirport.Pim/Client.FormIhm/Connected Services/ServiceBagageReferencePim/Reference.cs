...
namespace Client.FormIhm.ServiceBagageReferencePim {
    ...
    public partial class BagageDefinition : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        {
            return String.Format("Bagage: {0}, Compagnie :{1}, Ligne{2}", CodeIata, Compagnie, Ligne);
        }
    }
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ServiceBagageReferencePim.IServicePim")]
    public interface IServicePim {
        ...
        Client.FormIhm.ServiceBagageReferencePim.BagageDefinition GetBagageById(int idBagage);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/GetBagageById", ReplyAction="http://tempuri.org/IServicePim/GetBagageByIdResponse")]
        System.Threading.Tasks.Task<Client.FormIhm.ServiceBagageReferencePim.BagageDefinition> GetBagageByIdAsync(int idBagage);
        ...
        Client.FormIhm.ServiceBagageReferencePim.BagageDefinition[] GetBagageByCodeIata(string codeIata);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/GetBagageByCodeIata", ReplyAction="http://tempuri.org/IServicePim/GetBagageByCodeIataResponse")]
        System.Threading.Tasks.Task<Client.FormIhm.ServiceBagageReferencePim.BagageDefinition[]> GetBagageByCodeIataAsync(string codeIata);
        ...
        int CreateBagage(Client.FormIhm.ServiceBagageReferencePim.BagageDefinition bag);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServicePim/CreateBagage", ReplyAction="http://tempuri.org/IServicePim/CreateBagageResponse")]
        System.Threading.Tasks.Task<int> CreateBagageAsync(Client.FormIhm.ServiceBagageReferencePim.BagageDefinition bag);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServicePimChannel : Client.FormIhm.ServiceBagageReferencePim.IServicePim, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServicePimClient : System.ServiceModel.ClientBase<Client.FormIhm.ServiceBagageReferencePim.IServicePim>, Client.FormIhm.ServiceBagageReferencePim.IServicePim {
        ...
        public Client.FormIhm.ServiceBagageReferencePim.BagageDefinition GetBagageById(int idBagage) {
            return base.Channel.GetBagageById(idBagage);
        }
        
        public System.Threading.Tasks.Task<Client.FormIhm.ServiceBagageReferencePim.BagageDefinition> GetBagageByIdAsync(int idBagage) {
            return base.Channel.GetBagageByIdAsync(idBagage);
        }
        
        public Client.FormIhm.ServiceBagageReferencePim.BagageDefinition[] GetBagageByCodeIata(string codeIata) {
            return base.Channel.GetBagageByCodeIata(codeIata);
        }
        
        public System.Threading.Tasks.Task<Client.FormIhm.ServiceBagageReferencePim.BagageDefinition[]> GetBagageByCodeIataAsync(string codeIata) {
            return base.Channel.GetBagageByCodeIataAsync(codeIata);
        }
        
        public int CreateBagage(Client.FormIhm.ServiceBagageReferencePim.BagageDefinition bag) {
            return base.Channel.CreateBagage(bag);
        }
        
        public System.Threading.Tasks.Task<int> CreateBagageAsync(Client.FormIhm.ServiceBagageReferencePim.BagageDefinition bag) {
